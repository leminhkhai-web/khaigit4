...
<div class="title_mod"><img src="./img_LMK/khoiphuc.png" alt="" class="iconimg">Cập nhật loại hàng</div>
<div class="content_mod">
    <form name="updatehanghoa" id="formupdate" method="post" enctype="multipart/form-data" action="./elements_LMK/mhanghoa/hanghoaAct.php?reqact=updatehanghoa">
